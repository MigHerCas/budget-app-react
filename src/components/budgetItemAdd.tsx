...
const BudgetItemAdd = (props: BudgetItemAddInterface): JSX.Element => {
  ...
  return (
    <div className="modal-wrapper">
      <div className="modal-dialog">
        <button className="btn btn-cross" onClick={() => props.handleShowAddItem(!props.showAddItem)}>
          ⨯
        </button>
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <fieldset>
            ...
            <label className="custom-checkbox-label" htmlFor="isPaid">
              {' '}
